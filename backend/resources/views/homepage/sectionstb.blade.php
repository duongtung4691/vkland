...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <form class="form-horizontal form-label-left input_mask" action="{{ url('templates/sectionstb') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="group_post" style="padding-top: 20px; padding-bottom: 20px; border: 2px; border-bottom-color: #0f0f0f">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Ảnh đại diện {{ config()->get('constants.LABEL_SIZE_THUMBNAIL_STBH') }}</label>
